...
- 9ba3d5b: Fix duotone status icons rendering with the wrong color in React Native
...
- 9746c98: Switched the default icon color in React Native to use a semantic color token.
