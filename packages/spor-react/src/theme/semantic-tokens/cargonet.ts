export const cargonet = {
  ...
  text: {
    ...
    secondary: {
      value: {
        _light: "{colors.champagne}",
        _dark: "{colors.champagne}",
      },
    },
    tertiary: {
      value: {
  ...
  brand: {
    surface: {
      DEFAULT: {
        value: {
          _light: "{colors.saffron}",
          _dark: "{colors.saffron}",
        },
      },
      hover: {
        value: {
          _light: "{colors.pumpkin}",
          _dark: "{colors.pumpkin}",
        },
      },
      active: {
        value: {
